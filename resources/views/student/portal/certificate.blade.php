    ...
    <div class="certificate-container">
        ...
        <div class="header">
            <div class="logo-container">
                ...
                <div
                    style="width: 100px; height: 100px; display: flex; align-items: center; justify-content: center; font-size: 10px; color: #999;">
        ...
        <div class="certification-text">
            This is to certify that Mr./Ms. <span class="underline"
                style="padding: 5px;">&nbsp&nbsp&nbsp&nbsp{{ strtoupper($user->name) }}&nbsp&nbsp&nbsp&nbsp</span>
            with student number <span class="underline"
                style="padding: 5px;">&nbsp&nbsp&nbsp&nbsp{{ $user->student_number ?? 'N/A' }}&nbsp&nbsp&nbsp&nbsp</span>
            ...
            @if($groupedEnrollments->isNotEmpty())
                @php
                    ...
                    $semester = $parts[1] ?? '';
                @endphp
                <span class="underline">&nbsp&nbsp&nbsp&nbsp{{ strtoupper($semester) }}&nbsp&nbsp&nbsp&nbsp</span> semester
                of AY <span class="underline"
                    style="padding: 5px;">&nbsp&nbsp&nbsp&nbsp{{ $academicYear }}&nbsp&nbsp&nbsp&nbsp</span>
            @else
                <span class="underline">&nbsp&nbsp&nbsp&nbsp&nbsp</span> semester of AY <span
                    class="underline">&nbsp&nbsp&nbsp&nbsp&nbsp</span>
            @endif
            :
        </div>
                ...
                <tbody>
                    ...
                    @foreach($groupedEnrollments->first() as $enrollment)
                        @php
                            ...
                            $isNSTP = in_array(strtoupper($course->code ?? ''), ['NSTP 1', 'NSTP 2', 'NSTP1', 'NSTP2']);

                            // Determine if completed (not 5.00, INC, DRP)
                            $isCompleted = false;
                            $creditUnits = 0;
                            if ($gradeValue && !in_array(strtoupper($gradeValue), ['6.00', '7.00'])) {
                                $isCompleted = true;
                                $creditUnits = $units;
                                $totalPassed++;
                                ...
                                // Exclude NSTP from weighted average calculation
                                if (
                                    !$isNSTP &&
        ...
        @endif
            ...
            <div class="grading-scale">
                ...
                <b>1.00</b> - 100 - 96.7; &nbsp&nbsp&nbsp<b>1.25</b> - 96.6 - 93.4; &nbsp&nbsp&nbsp<b>1.50</b> - 93.3 -
                90.1; &nbsp&nbsp<b>1.75</b> - 90.0 - 86.7<br>
                <b>2.00</b> - 86.6 - 83.4; &nbsp&nbsp<b>2.25</b> - 83.3 - 80.1; &nbsp&nbsp&nbsp<b>2.50</b> - 80.0 -
                76.7; &nbsp&nbsp<b>2.75</b> - 76.6 - 73.4<br>
                <b>3.00</b> - 73.3 - 70.0; &nbsp&nbsp<b>4.00</b> - Conditional; &nbsp&nbsp<b>5.00</b> - Failed;
                &nbsp&nbsp&nbsp<b>Inc.&nbsp&nbsp</b> - Incomplete; &nbsp&nbsp<b>Drp.</b> - Dropped
            </div>
