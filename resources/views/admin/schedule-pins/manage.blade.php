...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-6 space-y-4">
        <p class="text-sm text-gray-600">
            As an <strong>administrator</strong>, you can assign or update a
        ...
        <form method="POST" action="{{ route('admin.schedule-pins.update') }}" class="space-y-4">
            @csrf
...
<script>
    ...
    input.addEventListener('input', function () {
        ...
        debounceTimer = setTimeout(() => {
            fetch(`{{ route('admin.schedule-pins.info') }}?code=${encodeURIComponent(code)}`)
